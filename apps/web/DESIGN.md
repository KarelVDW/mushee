...
- **Dock popovers become sheets.** Clef / key / time / tempo popovers span the dock's width (`popoverPosition(compact)`) instead of anchoring to their chip — anchored panels clip at the viewport edge.
