...
const GLYPHS = {
    'alert-triangle':
        '<path d="M12 3 21.5 19.5H2.5L12 3Z"/><path d="M12 9.5V14"/><circle cx="12" cy="17" r="1.3" fill="currentColor" stroke="none"/>',
    ...
    'bell-off':
        '<path d="M12 4a6 6 0 0 0-6 6v4.5L4 18h16l-2-3.5V10a6 6 0 0 0-6-6Z"/><path d="M10.5 21h3"/><path d="m4 4 16 16"/>',
    bookmark: '<path d="M6.5 21V3.5h11V21L12 16.5 6.5 21Z"/>',
    calendar:
        '<path d="M3.5 5.5h15a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-13a2 2 0 0 1-2-2v-13Z"/><path d="M8 3v4"/><path d="M16 3v4"/><path d="M3.5 10.5h17"/><path d="M15.5 15h.01"/>',
    check: '<path d="m5 12.5 4.5 4.5L19 7"/>',
    'check-circle': '<circle cx="12" cy="12" r="8.5"/><path d="m8 12.5 2.8 2.8 5.2-6.3"/>',
    ...
    clipboard:
        '<rect x="9" y="2.5" width="6" height="3.5"/><path d="M15.5 4.5H17a2 2 0 0 1 2 2V19a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6.5a2 2 0 0 1 2-2h1.5"/>',
    clock: '<circle cx="12" cy="12" r="8.5"/><path d="M12 7v5l3.5 2"/>',
    cloud: '<path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/>',
    copy: '<path d="M8.5 8.5h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-8a2 2 0 0 1-2-2v-10Z"/><path d="M15.5 4.5h-9a2 2 0 0 0-2 2v9"/>',
    'credit-card':
    ...
    'file-music':
        '<path d="M13.5 3.5H7a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9l-5.5-5.5Z"/><path d="M13.5 3.5V9H19"/><path d="M12 16.1v-5l3.4 1"/><circle cx="10.4" cy="16.1" r="1.6" fill="currentColor" stroke="none"/>',
    filter: '<path d="M21 4.5H3l7 8.5v5.5l4 2.5v-8l7-8.5Z"/>',
    flag: '<path d="M5 21.5V3.5"/><path d="M5 4.5h14.5l-3.5 4.5 3.5 4.5H5"/>',
    ...
    gift: '<rect x="3" y="7.5" width="18" height="4.5"/><path d="M5 12v8.5h14V12"/><path d="M12 7.5v13"/><path d="M7.75 7.5a2.4 2.4 0 0 1 0-4.8C11 2.7 12 7.5 12 7.5s1-4.8 4.25-4.8a2.4 2.4 0 0 1 0 4.8"/>',
    globe: '<circle cx="12" cy="12" r="8.5"/><path d="M3.5 12h17"/><path d="M12 3.5c3.4 4.7 3.4 12.3 0 17-3.4-4.7-3.4-12.3 0-17Z"/>',
    ...
    'grip-vertical':
        '<path d="M9 5.5h.01"/><path d="M15 5.5h.01"/><path d="M9 12h.01"/><path d="M15 12h.01"/><path d="M9 18.5h.01"/><path d="M15 18.5h.01"/>',
    headphones:
        '<path d="M3.5 16v-2.5a8.5 8.5 0 0 1 17 0V16"/><rect x="3.5" y="14.5" width="4.5" height="6" rx="1.5"/><rect x="16" y="14.5" width="4.5" height="6" rx="1.5"/>',
    ...
    'help-circle':
        '<circle cx="12" cy="12" r="8.5"/><path d="M9.2 9a2.9 2.9 0 0 1 5.6 1c0 1.9-2.8 2.3-2.8 3.7"/><circle cx="12" cy="17" r="1.3" fill="currentColor" stroke="none"/>',
    home: '<path d="m3.5 11.5 8.5-8 8.5 8"/><path d="M5.5 10v10h13V10"/><path d="M10 20v-5.5h4V20"/>',
    ...
    list: '<path d="M4 6h.01"/><path d="M4 12h.01"/><path d="M4 18h.01"/><path d="M8.5 6h12"/><path d="M8.5 12h12"/><path d="M8.5 18h12"/>',
    loader: '<path d="M12 2.5v4"/><path d="M12 17.5v4"/><path d="M2.5 12h4"/><path d="M17.5 12h4"/><path d="m5.3 5.3 2.8 2.8"/><path d="m15.9 15.9 2.8 2.8"/><path d="m18.7 5.3-2.8 2.8"/><path d="m8.1 15.9-2.8 2.8"/>',
    ...
    metronome: '<path d="M9.5 3.5h5L18 20.5H6L9.5 3.5Z"/><path d="M7 16.5h10"/><path d="m12 16.5 4-8.5"/>',
    ...
    'more-vertical': '<path d="M12 5h.01"/><path d="M12 12h.01"/><path d="M12 19h.01"/>',
    ...
    piano: '<rect x="2.5" y="6.5" width="19" height="11"/><path d="M7.25 6.5v5.5"/><path d="M12 6.5v5.5"/><path d="M16.75 6.5v5.5"/>',
    play: '<path d="M7.5 4.5 19.5 12 7.5 19.5Z"/>',
    plus: '<path d="M12 4.5v15"/><path d="M4.5 12h15"/>',
    printer:
        '<path d="M6.5 8.5V3.5h11v5"/><path d="M6.5 17H5.5a2 2 0 0 1-2-2v-4.5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2V15a2 2 0 0 1-2 2h-1"/><rect x="6.5" y="13.5" width="11" height="7"/>',
    redo: '<path d="m15 14 4.5-4.5L15 5"/><path d="M19.5 9.5h-11A4.5 4.5 0 0 0 4 14v6"/>',
    'refresh-cw': '<path d="M20.5 12a8.5 8.5 0 1 1-2.5-6l2.7 2.4"/><path d="M20.7 3.4v5h-5"/>',
    repeat: '<path d="m17.5 2.5 3.5 3.5-3.5 3.5"/><path d="M3.5 11.5V10a4 4 0 0 1 4-4H21"/><path d="m6.5 21.5-3.5-3.5 3.5-3.5"/><path d="M20.5 12.5V14a4 4 0 0 1-4 4H3"/>',
    'rotate-ccw': '<path d="M3.5 12a8.5 8.5 0 1 0 2.5-6L3.3 8.4"/><path d="M3.3 3.4v5h5"/>',
    scissors:
        '<circle cx="6" cy="6" r="2.75"/><circle cx="6" cy="18" r="2.75"/><path d="M20.5 4 8.1 15.9"/><path d="M14.7 14.7 20.5 20"/><path d="M8.1 8.1 12 12"/>',
    search: '<circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5.5 5.5"/>',
    send: '<path d="M21.5 2.5 14.3 21.5l-3.7-8.1-8.1-3.7Z"/><path d="M21.5 2.5 10.6 13.4"/>',
    settings:
        '<circle cx="12" cy="12" r="6.5"/><path d="m12 12 3.2-3.2"/><path d="M12 2.5v2"/><path d="M12 19.5v2"/><path d="M2.5 12h2"/><path d="M19.5 12h2"/>',
    'share-2':
        '<circle cx="6" cy="12" r="2.75"/><circle cx="17.5" cy="5.5" r="2.75"/><circle cx="17.5" cy="18.5" r="2.75"/><path d="m8.4 10.7 6.7-3.9"/><path d="m8.4 13.3 6.7 3.9"/>',
    shield: '<path d="M12 3l8 3.5v6L12 21l-8-8.5v-6Z"/>',
    'skip-back': '<path d="M5.5 5v14"/><path d="M19 5.5 9.5 12l9.5 6.5Z"/>',
    'skip-forward': '<path d="M18.5 5v14"/><path d="M5 5.5 14.5 12 5 18.5Z"/>',
    'sliders-horizontal':
    ...
    sun: '<circle cx="12" cy="12" r="4"/><path d="M12 2.5v3"/><path d="M12 18.5v3"/><path d="M2.5 12h3"/><path d="M18.5 12h3"/><path d="m15.9 8.1 2.8-2.8"/><path d="M8.1 8.1 5.3 5.3"/><path d="m15.9 15.9 2.8 2.8"/><path d="m8.1 15.9-2.8 2.8"/>',
    tag: '<path d="M3.5 3.5H12l8.5 8.5-8.5 8.5-8.5-8.5V3.5Z"/><path d="M8 8h.01"/>',
    'trash-2':
        '<path d="M4 7h16"/><path d="M9.5 7V4.5h5V7"/><path d="M5.5 7l1.2 13.5h10.6L18.5 7"/><path d="M10 11v6"/><path d="M14 11v6"/>',
    undo: '<path d="m9 14-4.5-4.5L9 5"/><path d="M4.5 9.5h11a4.5 4.5 0 0 1 4.5 4.5v6"/>',
    upload: '<path d="M12 15V4"/><path d="m6.5 9.5 5.5-5.5 5.5 5.5"/><path d="M4 17v3.5h16V17"/>',
    user: '<circle cx="12" cy="7.5" r="4"/><path d="M5 20.5a7 7 0 0 1 14 0"/>',
    'user-plus':
        '<circle cx="9.5" cy="7.5" r="3.75"/><path d="M3 20.5a6.5 6.5 0 0 1 13 0"/><path d="M19 8.5v6"/><path d="M16 11.5h6"/>',
    ...
    volume: '<path d="M11.5 4.5v15L6.5 15.5H3.5v-7h3l5-4Z"/><path d="M15.5 9a4.2 4.2 0 0 1 0 6"/><path d="M18.3 6.5a8 8 0 0 1 0 11"/>',
    'volume-x': '<path d="M11.5 4.5v15L6.5 15.5H3.5v-7h3l5-4Z"/><path d="m16 9.5 5 5"/><path d="m21 9.5-5 5"/>',
    ...
    'zoom-in': '<circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5.5 5.5"/><path d="M10.5 8v5"/><path d="M8 10.5h5"/>',
    'zoom-out': '<circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5.5 5.5"/><path d="M8 10.5h5"/>',
}
