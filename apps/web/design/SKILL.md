...
If working on production code, you can copy assets and read the rules in `README.md` to become an expert in designing with this brand. The production source of truth is the Next.js app at `apps/web/` (this design system lives inside it at `apps/web/design/`).
