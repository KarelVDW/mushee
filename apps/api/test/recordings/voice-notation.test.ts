...
const FRERE = [
  note(46.45, 0), note(48.65, 0.5), note(50.65, 1.0), note(46.55, 1.5),
  note(46.4, 2.0), note(48.7, 2.5), note(50.7, 3.0), note(46.6, 3.5),
];
...
describe('chooseNamingOffset', () => {
  it('lets the key pick the naming when the shift is near half a semitone', () => {
    ...
    expect(FRERE.map((n) => spellMidi(n, flipped, null))).toEqual([
      46, 48, 50, 46, 46, 48, 50, 46,
    ]);
  });
