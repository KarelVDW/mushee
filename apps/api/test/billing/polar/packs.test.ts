...
import { isPackId, PACK_SECONDS, packForProduct, productIdForPack } from '../../../src/billing/polar/packs'
...
describe('polar pack mapping', () => {
    ...
    it('returns null for unconfigured or blank packs', () => {
        ...
        expect(productIdForPack('single', { POLAR_PRODUCT_PACK_SINGLE: '  ' } as NodeJS.ProcessEnv)).toBeNull()
    })
