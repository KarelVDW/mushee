...
import { intervalForProduct, isBillingInterval, isPaidTierId, productIdFor, tierForProduct } from '../../../src/billing/polar/products'
...
describe('polar product mapping', () => {
    ...
    it('treats blank env values as unconfigured', () => {
        expect(productIdFor('pro', 'monthly', { POLAR_PRODUCT_PRO_MONTHLY: '  ' } as NodeJS.ProcessEnv)).toBeNull()
    })
