...
export class InitialSchema1783296000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD COLUMN "role" text NOT NULL DEFAULT 'user'`)
        await queryRunner.query(`ALTER TABLE "user" ADD COLUMN "betaStatus" text`)
        await queryRunner.query(`CREATE INDEX "IDX_user_betaStatus" ON "user" ("betaStatus") WHERE "betaStatus" IS NOT NULL`)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_scores_userId_updatedAt" ON "scores" ("userId", "updatedAt")`)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cached_scores_updatedAt" ON "cached_scores" ("updatedAt")`)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_recordings_userId" ON "recordings" ("userId")`)
        await queryRunner.query(`CREATE INDEX "IDX_recordings_scoreId" ON "recordings" ("scoreId")`)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_account_deletions_purgeAfter" ON "account_deletions" ("purgeAfter")`)
    }
