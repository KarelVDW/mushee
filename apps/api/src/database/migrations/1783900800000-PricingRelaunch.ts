...
export class PricingRelaunch1783900800000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = 180 WHERE "id" = 'free'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "name" = 'Songwriter', "dailyRecordingCredits" = 1200 WHERE "id" = 'pro'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = 10800 WHERE "id" = 'studio'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = 1800, "sortOrder" = 4 WHERE "id" = 'beta'`)
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "subscription_tiers" WHERE "id" = 'arranger'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = 300, "sortOrder" = 3 WHERE "id" = 'beta'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = NULL WHERE "id" = 'studio'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "name" = 'Composer', "dailyRecordingCredits" = 600 WHERE "id" = 'pro'`)
        await queryRunner.query(`UPDATE "subscription_tiers" SET "dailyRecordingCredits" = 30 WHERE "id" = 'free'`)
    }
}
