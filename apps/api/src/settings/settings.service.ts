...
import { InvalidShortcutsError, sanitizeStoredShortcuts, StoredShortcuts } from './stored-shortcuts'
...
export class SettingsService {
    ...
    async setKeyboardShortcuts(userId: string, input: unknown): Promise<UserSettingsView> {
