...
export const ONBOARDING_BACKGROUNDS = ['curious', 'hobbyist', 'student', 'teacher', 'composer', 'professional'] as const

export const ONBOARDING_GOALS = ['transcribe', 'compose', 'arrange', 'teach', 'learn'] as const

export const ONBOARDING_SOURCES = ['friend', 'search', 'social', 'youtube', 'teacher', 'blog', 'other'] as const
