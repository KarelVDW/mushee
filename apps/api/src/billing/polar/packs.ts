...
export function productIdForPack(packId: PackId, env: NodeJS.ProcessEnv = process.env): string | null {
...
export function packForProduct(productId: string | null | undefined, env: NodeJS.ProcessEnv = process.env): PackId | null {
