...
export class BillingController {
    ...
    @Post('checkout')
    checkout(@CurrentUser() user: { id: string; email: string }, @Body() dto: CreateCheckoutDto, @Req() req: FastifyRequest) {
    ...
    @Post('checkout/pack')
    packCheckout(@CurrentUser() user: { id: string; email: string }, @Body() dto: CreatePackCheckoutDto, @Req() req: FastifyRequest) {
    ...
    @Post('change')
    change(@CurrentUser() user: { id: string }, @Body() dto: CreateCheckoutDto) {
