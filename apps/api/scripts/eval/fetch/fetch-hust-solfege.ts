...
const AUDIO_URL = 'https://media.githubusercontent.com/media/itec-hust/HUST_Solfege/master/wav/HUST_Solfege.zip'
 ...
 */
function calibrateOffset(wav: { samples: Int16Array; sampleRate: number }, rows: AnnRow[]): { offset: number; n: number } {
...
function main(): void {
    ...
    console.log(`\nConverted ${clips} HUST_Solfege clips (${totalNotes} notes, ` + `${fallbacks} offset fallbacks) into ${OUT}`)
}
